...
<div class="max-w-7xl h-16 mx-auto flex items-center px-4 justify-between">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                stroke="currentColor"
                class="w-10 h-10 md:hidden text-white cursor-pointer py-2 hover:bg-indigo-800 rounded-lg">
...
const cloneBtnDesktop = navbar.children[0].children[2].children[0];
const cloneBtnMobile = navbar.children[0].children[3].children[0];



cloneBtnDesktop.addEventListener('click', async e => {
    try {
...
cloneBtnMobile.addEventListener('click', async e => {
    try {
        await axios.get('/api/logout');
        window.location.pathname = '/login';
    } catch (error) {
